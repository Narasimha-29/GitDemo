...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("y19ec1367@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Narasimha@123");
		...
		Boolean Matchedproduct = Cartproducts.stream().anyMatch(Cartproduct->Cartproduct.getText().equalsIgnoreCase(ProductName));
