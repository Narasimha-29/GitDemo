package ProjectMaven.SeleniumWebDriverDesign.Test.TestComponent;
...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException
	{
		...
		FileInputStream fil = new FileInputStream(System.getProperty("user.dir")+
				"\\src\\test\\java\\ProjectMavenSeleniumWebDriverDesign\\resource\\GlobalData.properties");
		prop.load(fil);
